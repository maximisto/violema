...
const urlList = [
  ...
  `${baseUrl}/blog/reviewable-ai-operator-for-founder-led-teams/`,
  `${baseUrl}/blog/agentic-ai-for-startup-operations/`,
  `${baseUrl}/blog/competitor-intelligence-ai-agent/`,
  `${baseUrl}/blog/customer-risk-monitoring-ai-agent/`,
