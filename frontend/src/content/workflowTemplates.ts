...
export const WORKFLOW_TEMPLATES: WorkflowTemplateDefinition[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      // back so every run inherits the last one. Keep in sync with
      // backend/src/scheduler.ts auto_competitor_monitor.
