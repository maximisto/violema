...
export const WORKFLOW_TEMPLATES: WorkflowTemplateDefinition[] = [
  {
    ...
    integrations: ['Stripe', 'GitHub', 'Gmail', 'Google Calendar', 'Google Drive', 'Linear', 'Notion', 'Web search'],
    ...
    steps: [
      ...
      { kind: 'query', title: 'Review Linear backlog', objective: 'Pull delivery backlog, blockers, and execution risk from Linear when connected.', inputs: { source: 'linear', query_type: 'delivery_backlog' }, optional: true },
      { kind: 'query', title: 'Scan Notion operating context', objective: 'Find recently relevant strategy notes, investor notes, and operating context from Notion when connected.', inputs: { source: 'notion', query_type: 'operating_context' }, optional: true },
  ...
  },
  {
    ...
    destination: 'slack',
    notify: '#all-purple-orange',
    integrations: ['Stripe', 'GitHub', 'Linear', 'Web search'],
    ...
    steps: [
      ...
      { kind: 'query', title: 'Read Linear execution risk', objective: 'Read Linear backlog and blockers when Linear is connected.', inputs: { source: 'linear', query_type: 'blockers' }, optional: true },
