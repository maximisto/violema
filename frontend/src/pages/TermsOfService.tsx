...
const SECTIONS = [
  {
    ...
    content: `By accessing or using Nexus (the "Service") provided by Purple Orange AI, Inc. ("Purple Orange AI", "we", "us", "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, do not use the Service.

These Terms apply to all visitors, users, and others who access or use the Service. By using Nexus on behalf of an organisation, you represent that you have authority to bind that organisation to these Terms.
...
Last updated: March 28, 2026.`,
  },
  {
    ...
    content: `Nexus is an AI-powered work execution platform that allows users to interact with AI assistants, connect third-party integrations, and automate business tasks. The Service is powered by Anthropic's Claude AI and processes user requests through various connected tools and APIs.
...
**Age requirement.** You must be at least 16 years old to use the Service. By using Nexus, you represent that you meet this requirement.
...
We reserve the right to investigate violations and cooperate with law enforcement authorities.`,
  },
  {
    ...
    content: `**Nature of AI output.** Nexus uses Claude, a large language model, to generate responses. AI-generated content may sometimes be inaccurate, incomplete, or inappropriate. You should not rely on Nexus output for critical decisions — medical, legal, financial, or otherwise — without independent verification.
...
**No professional advice.** Nothing Nexus says constitutes professional legal, medical, financial, or other licensed professional advice.

**Autonomous actions.** When using Autonomous mode, Nexus may execute actions in connected tools without requiring your approval for each step. You accept responsibility for enabling this mode and for the actions taken.`,
  },
  {
    id: 'ip',
...
**Your content.** You retain ownership of content you create and input into the Service. By using Nexus, you grant Purple Orange AI a limited, non-exclusive licence to process your content solely to provide the Service.
...
**Feedback.** If you provide feedback or suggestions about the Service, you grant us a royalty-free licence to use that feedback without obligation to you.`,
  ...
  },
  {
    ...
    content: `Nexus allows you to connect third-party services (Slack, GitHub, Stripe, HubSpot, etc.). Your use of these services is governed by their own terms and privacy policies. Purple Orange AI is not responsible for the practices, content, or reliability of third-party services.

By connecting an integration, you authorise Nexus to interact with that service on your behalf within the scope of permissions you grant. You can revoke these permissions at any time from your account settings.`,
  },
  {
    id: 'payment',
    title: '9. Payment & Subscriptions',
    content: `**Billing.** Paid subscriptions are billed monthly or annually in advance. Prices are listed on our Pricing page and may change with 30 days' notice.

**Free trial.** Pro plans include a 14-day free trial. You will not be charged until the trial ends. You may cancel before the trial ends to avoid any charge.
      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <p className="text-xl text-slate-400 max-w-2xl">
            The rules of the road for using Nexus. We've tried to make this as readable as possible.
          </p>
        </div>
      </section>
          ...
          <main className="lg:col-span-3 space-y-10">
            ...
            <div className="p-5 rounded-xl bg-blue-500/5 border border-blue-500/20">
              ...
              <ul className="space-y-2">
                {[
                  'Use Nexus for legal purposes only — don\'t abuse it.',
