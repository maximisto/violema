...
export default function TopUpChooser({
  ...
  return (
    <>
      ...
      />
      <div className="absolute inset-x-4 top-1/2 z-50 mx-auto w-full max-w-3xl -translate-y-1/2 overflow-hidden rounded-[1.7rem] border border-navy-700/80 bg-gradient-to-b from-navy-900/98 via-navy-900/96 to-navy-950/98 shadow-[0_30px_90px_rgba(2,6,23,0.55)]">
        <div className="flex items-start justify-between gap-4 border-b border-navy-800/80 px-5 py-4 sm:px-6">
          <div>
            ...
            <h3 className="mt-3 text-xl font-semibold text-white">Choose a top-up</h3>
