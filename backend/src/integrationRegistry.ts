    ...
    credentialFields: [
      {
        ...
        help: 'Used to refresh read-only Google Drive access for workflow source-material searches.',
        secret: true,
        envKeys: ['GOOGLE_DRIVE_REFRESH_TOKEN'],
      },
      {
        name: 'accessToken',
        label: 'Google Drive access token',
        help: 'Optional short-lived token for local testing. Prefer a refresh token for durable workflows.',
        secret: true,
        envKeys: ['GOOGLE_DRIVE_ACCESS_TOKEN'],
      },
    ],
