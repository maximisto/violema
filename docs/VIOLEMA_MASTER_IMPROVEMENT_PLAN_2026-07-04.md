...
2. **Pricing implementation follow-through** (WP-5.2 / 4.2): decision is call-led workflow audit + bounded free preview + Start/Founder at $79/mo + Pro at $249/mo + Enterprise custom. First code pass reuses existing Stripe products/price IDs, ships `/pricing`, aligns landing CTAs, and adds public sample Run pages with monthly projections; remaining work is tenant-backed live Run pages and live Stripe env verification.
